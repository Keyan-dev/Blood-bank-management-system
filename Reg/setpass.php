        ...
        {  
                ...
                if($password1==$password2)
                {
                    ...
                    if(!$iquery)
                    {
                        ...
                        echo'<script type="text/javascript">window.location="setpass.php";</script>';
                ...
                <div class="modal-content modal-dialog-centered bg-light">
                    ...
                    <div class="modal-body">
                       <form action="" method="POST" class="login-form">
                            ...
                            <div class="form-group"style="font-family:Times New Roman;font-size:20px;margin:0;padding:5px 20px;">
                                ReEnter Password
								<input type="password" name="pass2" placeholder="re-enter Password" class="form-control" >
                            </div>
                            <center><button style="margin:0; width:300px;" type="submit" class="btn" name="passbtn" >Submit</button></center>
                        </form>
					</div>	
